...
@Test
public class TestQServTypeMapping
        extends AbstractTestQueryFramework
{
    ...
    public TestQServTypeMapping()
            throws Exception
    {
        this(new TestingMySqlServer("testuser", "testpass", "tpch"));
    }

    private TestQServTypeMapping(TestingMySqlServer mysqlServer)
    {
        super(() -> createQServQueryRunner(mysqlServer, emptyList()));
