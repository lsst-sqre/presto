...
@Test
public class TestQServIntegrationSmokeTest
        extends AbstractTestIntegrationSmokeTest
{
    private final TestingMySqlServer mysqlServer;

    public TestQServIntegrationSmokeTest()
            throws Exception
    {
        this(new TestingMySqlServer("testuser", "testpass", "tpch", "test_database"));
    }

    public TestQServIntegrationSmokeTest(TestingMySqlServer mysqlServer)
    {
        super(() -> createQServQueryRunner(mysqlServer, ORDERS));
