...
public class QServClient
        extends BaseJdbcClient
{
    @Inject
    public QServClient(JdbcConnectorId connectorId, BaseJdbcConfig config, QServConfig mySqlConfig)
            throws SQLException
    {
        super(connectorId, config, "`", connectionFactory(config, mySqlConfig));
    }

    private static ConnectionFactory connectionFactory(BaseJdbcConfig config, QServConfig mySqlConfig)
            throws SQLException
    {
